...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void iterateByForEach() {
         ...
         */
        Consumer<Customer> addNameToList = customer -> nameList.add(customer.getName());
        customerIterable.forEach(addNameToList);
    ...
    public void whoHaveNoEInYourName() {
         ...
         */
        Predicate<String> containse = string -> string.contains("e");
        nameCollection.removeIf(containse);
    ...
    public void replaceTheElements() {
         ...
         */
        UnaryOperator<String> wrapString = string -> "(" + string + ")";
        nameList.replaceAll(wrapString);
    ...
    public void sortByName() {
         ...
         */
        Comparator<String> nameComparator = Comparator.comparingInt(String::length);
