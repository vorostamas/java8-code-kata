...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void oldestCustomer() {
         ...
         */
        Comparator<Customer> ageComparator = Comparator.comparingInt(Customer::getAge);
        Optional<Customer> oldestCustomer = customerList.stream().collect(Collectors.maxBy(ageComparator));
